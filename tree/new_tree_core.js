// Author : linss<linss@ms1.url.com.tw>   LastModified : 2003/06/10
document.write("<div id=\"TreeScr\" style=\"behavior:url(#default#download)\"></div><table bor\
der=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td><div id=\"TreeRoot\"></div><div id=\"Tre\
eTemp_0\"></div></td></tr></table>")
...
if(s=="Down"){
if(LastIndex)
eval(LastIndex).className = "Tree_Out"
LastIndex = n
...
if(TreeTop>=0)
document.body.style.marginTop = TreeTop
if(TreeLeft>=0)
